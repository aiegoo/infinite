...
class bostan_TwitterOAuth
{
	...
	/** @var bostan_Twitter_OAuthConsumer */
	private $consumer;
	...
	public function __construct($consumerKey, $consumerSecret, $accessToken = null, $accessTokenSecret = null)
	{
		...
		$this->consumer = new bostan_Twitter_OAuthConsumer($consumerKey, $consumerSecret);
		$this->token = new bostan_Twitter_OAuthConsumer($accessToken, $accessTokenSecret);
	}
	...
	public function request($resource, $method, array $data = null, array $files = null)
	{
		...
		$request = bostan_Twitter_OAuthRequest::from_consumer_and_token($this->consumer, $this->token, $method, $resource, $files ? [] : $data);
		$request->sign_request(new bostan_Twitter_OAuthSignatureMethod_HMAC_SHA1, $this->consumer, $this->token);
 ...
 */
class bostan_TwitterException extends Exception
{
}