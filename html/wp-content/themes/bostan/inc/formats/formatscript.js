jQuery( document ).ready(function() {
	jQuery('.asalah_format_field_gallery').on('click', 'input[type="radio"]', function () {
		var parent = jQuery('.asalah_format_field_gallery');
		var checked = jQuery(this).attr('value');
		parent.removeClass('asalah_gallery_postoptions_revslider');
		parent.removeClass('asalah_gallery_postoptions_shortcode');
		parent.addClass('asalah_gallery_postoptions_'+checked);
	});
