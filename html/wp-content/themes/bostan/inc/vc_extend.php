      ...
      vc_map( array(
        ...
        "params" => array(
          ...
          array(
     				"type" => "checkbox",
     				"class" => "",
     				"heading" => "Disable Wpautop (fix text format issues if any)",
     				"param_name" => "disable_wpautop",
     				"default" =>  false,
             ),
           ),
         ));
          ...
          array(
     				...
     				"value" =>  '',
						 ...
						 array(
	      				"type" => "textfield",
	      				"class" => "",
	      				"heading" => "Number Of Testimonials to show in one slide",
	      				"param_name" => "slides",
	      				"value" =>  '1',
	              ),
           ),
        ...
        "params" => array(
          ...
          array(
	           ...
	           array(
	      				"type" => "dropdown",
	      				"class" => "",
	      				"heading" => "Link Members to their page",
	      				"param_name" => "link_member_page",
	      				"value" =>  array(
	 							'No' => 'no',
	 							'Yes' => 'yes',
	 						),
