				...
				if( !empty($options['value']['background-type']) ){
					...
					if( $options['value']['background-type'] == 'color' ){
						...
						if( !empty($options['value']['background-color']) ){
							...
							if( !empty($options['value']['background-extending']) && $options['value']['background-extending'] != 'none' ){
								$wrapper_background_atts['border-width'] = empty($wrapper_style_atts['border-width'])? '': $wrapper_style_atts['border-width'];
								unset($wrapper_style_atts['border-width']);
								$wrapper_background_atts['border-color'] = empty($wrapper_style_atts['border-color'])? '': $wrapper_style_atts['border-color'];
								unset($wrapper_style_atts['border-color']);
								$wrapper_background_atts['border-style'] = empty($wrapper_style_atts['border-style'])? '': $wrapper_style_atts['border-style'];
								unset($wrapper_style_atts['border-style']);
							}
