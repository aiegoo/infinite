		...
		class gdlr_core_pb_element_social_share{
			...
			static function get_options(){
				...
				return array(
					...
					'spacing' => array(
						...
						'options' => array(
							'icon-space' => array(
								'title' => esc_html__('Icon Left & Right Spaces', 'goodlayers-core'),
								'type' => 'text',
			...
			static function get_content( $settings = array(), $preview = false ){
				...
				$icon_style = array(
					...
					'margin-left' => empty($settings['icon-space'])? '': $settings['icon-space'],
					'margin-right' => empty($settings['icon-space'])? '': $settings['icon-space'],
				);
